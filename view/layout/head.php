...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    foreach($osztalyok as $kulcs => $ertek){
        if($kulcs != $osztaly){
            echo"<a class=\"dropdown-item\" href=\"index.php?osztalyId=$kulcs\">$ertek</a></h2>";
        }
        else{
            echo "<a class=\"dropdown-item disabled\" href=\"index.php?osztalyId=$kulcs\">$ertek</a></h2>";
        }
    }
    ?>
</div>
  ...
  <li class="nav-item">
    ...
    if(isset($_SESSION['id'])) {
        echo "<span>Üdv ".$_SESSION['nev']."!</span>";
    ...
    <form class="form-inline" method="post" action="lista.php">
      ...
      <input name="keresettNev" class="form-control mr-sm-2" type="search" placeholder="Search" 
      aria-label="Search" onkeyup="showHint(this.value)">
      <div id="txtHint"></div>
